const pe = {
  ...
  description:
    "P/E är en förkortning för price/earnings och är ett av de vanligaste nyckeltalen som används för att se om en aktie är köpvärd eller inte. Price står för aktiens pris och earnings står för bolagets vinst. Nyckeltalet visar alltså priset på en aktie i relation till bolagets vinst per aktie. Vinsten per aktie är bolagets totala vinst delat med antal aktier som finns i bolaget. <br/><br/> När man jämför P/E-tal med varandra är det viktigt att jämföra äpplen med äpplen och päron med päron. För börsbolagen innebär det att det är relevant att jämföra SEB och Swedbank men inte SEB och H&M. <br/><br/> (PLACEHOLDER FÖR JPG MED LINJEDIAGRAM SOM VISAR HISTORISKA PE FÖR VARJE BRANSCH). <br/><br/> Normalt brukar P/E-talet i snitt röra sig mellan 12-18 på Stockholmsbörsen, men det är stora skillnader mellan bolag beroende av deras tillväxtpotential. Bolag som växer mindre än fem procent per år handlas normalt till 5-12, de som växer 5-10 procent handlas ofta till 7-20 och de som har en tillväxt över 10 procent pendlar oftast mellan 15-25. <br/><br/> För att P/E talet ska säga något meningsfullt bör man därför som investerare göra två jämförelser: <br/><br/> <b>1. Jämför vilket P/E aktien historiskt har handlats till</b> (detta ger en bra vink om aktiekursen idag är 'dyr eller billig för tillfället'). <br/> <b>2. Jämför vilket P/E konkurrenter och branschen i genomsnitt handlas till</b> (detta ger en bra vink om aktiekursen är 'dyr eller billig'). <br/></br> VIKTIGT: Ett lågt P/E betyder inte per automatik att det är en bra investeringsmöjlighet. Det finns nästan alltid en förklaring till den låga värderingen och det är först om bolaget visar att man kan växa mer/snabbare som värderingen också kommer att justeras.",
  tags: ["pe", "värdering", "finansiell analys", "nyckeltal"],
  link: {
    title: "Avanza Akademin (Vad är nyckeltalet P/E-tal?)",
    href:
